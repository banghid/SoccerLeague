package com.banghid.soccerleague.repositories
...
class LeagueRepository {
    ...
    private var dataSet: ArrayList<LeagueModel> = arrayListOf()

    companion object {
        private var instance: LeagueRepository? = null
        fun getInstance(): LeagueRepository? {
            if (instance == null) {
                instance = LeagueRepository()
            }
            return instance
        }
    }
    ...
    private fun setLeagues() {
        ...
        dataSet.add(
            LeagueModel(
                ...
                "image/1_english_premier_league.webp",
                "England",
        ...
        dataSet.add(
            LeagueModel(
                "German Bundesliga",
                "image/3_german_bundesliga.webp",
                "Germany",
        ...
        dataSet.add(
            LeagueModel(
                ...
                "image/6_american_mayor_league.webp",
                "America",
        ...
        dataSet.add(
            LeagueModel(
                ...
                "image/7_portugeuese_premiera_liga.webp",
                "Portugis",
        ...
        dataSet.add(
            LeagueModel(
                "Australian A League",
                "image/8_australian_a_league.webp",
                "Australia",
        ...
        dataSet.add(
            LeagueModel(
                ...
                "image/9_scotish_premier_league.webp",
                "Scotland",
        ...
        dataSet.add(
            LeagueModel(
                "English League 1",
                "image/10_english_league_1.webp",
                "England",
    ...
    fun getLeagues(): MutableLiveData<List<LeagueModel>> {
        setLeagues()

        val data: MutableLiveData<List<LeagueModel>> = MutableLiveData()
        data.value = dataSet
